...
tables={
    ...
    '000010':(0,4), '00000011':(1,4), '00000010':(2,4), '0000000':(3,4) } # nC == -1
      ...
      '000000000000001':14, '0000000000000001':15 }, # Tab 9-6, page 180
        "runBeforeMapping1" = { '1':0, '0': 1 },
        "runBeforeMapping2" = { '1':0, '01': 1, '00':2 },
        "runBeforeMapping3" = { '11':0, '10': 1, '01':2, '00':3 },
        "runBeforeMapping4" = { '11':0, '10': 1, '01':2, '001':3, '000':4 },
        "runBeforeMapping5" = { '11':0, '10': 1, '011':2, '010':3, '001':4, '000':5 },
        "runBeforeMapping6" = { '11':0, '000': 1, '001':2, '011':3, '010':4, '101':5, '100':6 },
        "runBeforeMapping7" = { '111':0, '110': 1, '101':2, '100':3, '011':4, '010':5, '001':6, '0001':7,
      '00001':8, '000001':9, '0000001':10, '00000001':11, '000000001':12, '0000000001':13, '00000000001':14},
        # ChromaDC
        "totalZerosMappingDC1" = { '1':0, '01':1, '001':2, '000':3 },
        "totalZerosMappingDC2" = { '1':0, '01':1, '00':2 },
        "totalZerosMappingDC3" = { '1':0, '0':1 },

        "totalZerosMapping1" = { '1':0, '011':1, '010':2, '0011':3, '0010':4, '00011':5, '00010':6, '000011':7,
        '000010':8, '0000011':9, '0000010':10, '00000011':11, '00000010':12, '000000011':13, '000000010':14, '000000001':15 },
        "totalZerosMapping2" = { '111':0, '110':1, '101':2, '100':3, '011':4, '0101':5, '0100':6, 
        '0011':7, '0010':8, '00011':9, '00010':10, '000011':11, '000010':12, '000001':13, '000000':14},
        "totalZerosMapping3" = { '0101':0, '111':1, '110':2, '101':3, '0100':4, '0011':5, '100':6,
        '011':7, '0010':8, '00011':9, '00010':10, '000001':11, '00001':12, '000000':13 },
        "totalZerosMapping4" = { '00011':0, '111':1, '0101':2, '0100':3, '110':4, '101':5, '100':6,
        '0011':7, '011':8, '0010':9, '00010':10, '00001':11, '00000':12 },
        "totalZerosMapping5" = { '0101':0, '0100':1, '0011':2, '111':3, '110':4, '101':5, '100':6,
        '011':7, '0010':8, '00001':9, '0001':10, '00000':11 },
        "totalZerosMapping6" = { '000001':0, '00001':1, '111':2, '110':3, '101':4, '100':5, '011':6,
        '010':7, '0001':8, '001':9, '000000':10 },
        "totalZerosMapping7" = { '000001':0, '00001':1, '101':2, '100':3, '011':4, '11':5, '010':6, '0001':7, '001':8, '000000':9 },
        "totalZerosMapping8" = { '000001':0, '0001':1, '00001':2, '011':3, '11':4, '10':5, '010':6, '001':7, '000000':8 } ,
        "totalZerosMapping9" = { '000001':0, '000000':1, '0001':2, '11':3, '10':4, '001':5, '01':6, '00001':7 },
        "totalZerosMapping10" = { '00001':0, '00000':1, '001':2, '11':3, '10':4, '01':5, '0001':6 },
        "totalZerosMapping11" = { '0000':0, '0001':1, '001':2, '010':3, '1':4, '011':5 },
        "totalZerosMapping12" = { '0000':0, '0001':1, '01':2, '1':3, '001':4 },
        "totalZerosMapping13" = { '000':0, '001':1, '1':2, '01':3 },
        "totalZerosMapping14" = { '00':0, '01':1, '1':2 },
        "totalZerosMapping15" = { '0':0, '1':1 },
    }
...
def makeAutomat(mapping):
    ...
    automat=array('i',[-1,-1])
    results=[]
    for bits, data in mapping.iteritems():
        state=0
        ...
        automat[state|bit]=(len(results)<<1)|1
        results.append(data)
...
def decoder(automat, results, input):
    state=0
    for bit in input:
        state=automat[state | bit]
        if state&1:
            yield results[state>>1] 
            state=0

class DecoderBitStream:
  def __init__( self, buf="" ):
    self.iter = bitGeneratorWithGlobalCount(buf)
    self.decoders={}
    for name,t in tables.iteritems():
        automat,results=makeAutomat(t)
        self.decoders[name]=decoder(automat, results, self.iter)
  ...
  def decoded(tablename):
      return self.decoders[tablename].next()
